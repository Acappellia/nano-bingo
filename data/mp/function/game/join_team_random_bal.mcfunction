...
execute unless score #team_member_max mp matches 3.. run scoreboard players set #target_score bingo_score 1
execute if score #team_member_max mp matches 3..5 run scoreboard players set #target_score bingo_score 2
execute if score #team_member_max mp matches 6.. run scoreboard players set #target_score bingo_score 3
