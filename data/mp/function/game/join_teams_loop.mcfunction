...
execute if score #team_loop mp matches 1 run team join blue @s
execute if score #team_loop mp matches 1 run tellraw @s [{"text": "> ","color": "gold"},{"text": "您已加入","color": "white"},{"text": "蓝队","color": "aqua"}]
...
execute if score #team_loop mp matches 3 run team join green @s
execute if score #team_loop mp matches 3 run tellraw @s [{"text": "> ","color": "gold"},{"text": "您已加入","color": "white"},{"text": "绿队","color": "green"}]
