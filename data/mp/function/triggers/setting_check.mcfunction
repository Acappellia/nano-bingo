...
execute if score #max_team mp matches 1 run tellraw @s [{"text": "> ","color": "gold"},{"text": "最大队伍数 - ","color": "white"},{"text": "1","color": "yellow"},{"text": " (合作模式)","color": "gray"}]
execute if score #max_team mp matches 2 run tellraw @s [{"text": "> ","color": "gold"},{"text": "最大队伍数 - ","color": "white"},{"text": "2","color": "yellow"}]
execute if score #max_team mp matches 3 run tellraw @s [{"text": "> ","color": "gold"},{"text": "最大队伍数 - ","color": "white"},{"text": "3","color": "yellow"}]
execute if score #max_team mp matches 4 run tellraw @s [{"text": "> ","color": "gold"},{"text": "最大队伍数 - ","color": "white"},{"text": "4","color": "yellow"}]
