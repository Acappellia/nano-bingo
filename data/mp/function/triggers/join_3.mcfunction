...
execute if score #max_team mp matches ..2 run tellraw @s [{"text": "> ","color": "gold"},{"text": "未启用该队伍，无法加入","color": "gray"}]
execute if score #max_team mp matches ..2 run return -1

team join blue
tellraw @a [{"text": ">","color": "gold"},{"text": " ","color": "white"},{"selector":"@s"},{"text": " 已加入 ","color": "white"},{"text": "黄队","color": "yellow"}]