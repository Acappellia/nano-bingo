...
tellraw @a [{"text": ">","color": "gold"},{"text": " ","color": "white"},{"selector":"@s"},{"text": " 投票结束本局游戏，","color": "white"},{"text": "[ ","color": "gray"},{"text": "点击这里","color": "aqua","hoverEvent": {"action": "show_text","value": "投票结束本局游戏"},"clickEvent": {"action": "run_command","value": "/trigger game_vote_stop"}},{"text": " ] ","color": "gray"},{"text": " 加入投票","color": "white"}]
