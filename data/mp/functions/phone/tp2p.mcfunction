...
execute as @e[type=item_display,tag=tp2p,distance=..1] run data merge entity @s {teleport_duration:1,start_interpolation:-1}
...
execute if score @p[distance=..5,tag=tp_target] sprinting matches ..-1 at @s run tp @e[type=item_display,tag=tp2p,distance=..1] ^ ^ ^0.3 ~ ~
execute if score @p[distance=..5,tag=tp_target] boating matches ..-1 at @s run tp @e[type=item_display,tag=tp2p,distance=..1] ^ ^ ^0.8 ~ ~
